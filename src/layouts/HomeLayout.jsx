        ...
        <nav className="bg-white shadow">
            ...
            <div className="flex justify-between h-16">
                ...
                <div className="hidden md:ml-6 md:flex md:space-x-8">
                    ...
                    <Link 
                        to="/contacto"
                        className={`${location.pathname === '/contacto' ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium`}
                    >Contacto</Link>
                </div>
                </div>
      ...
      <footer className="bg-white" aria-labelledby="footer-heading">
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <form className="mt-4 sm:flex sm:max-w-md">
                ...
                <input type="email" name="email-address" id="email-address" required className="appearance-none min-w-0 w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-4 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:placeholder-gray-400" placeholder="Enter your email" />
                <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                <button type="submit" className="w-full bg-indigo-600 flex items-center justify-center border border-transparent rounded-md py-2 px-4 text-base font-medium text-white hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Subscribe</button>
                </div>
            </form>
            </div>
        </div>
