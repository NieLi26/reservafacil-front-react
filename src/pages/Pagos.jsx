...
const Pagos = () => {
    ...
    const handleCheckBoxChange = async (event) => {
        ...
        const listadoMetodos = Object.entries({
            ...checkBoxes,
            [name]: checked,
        ...
        setFilterMetodo(listadoMetodos)
      };
    ...
    useEffect(() => {
        obtenerPagos();
    }, [pagina, filterOrden, filterFecha, filterSearch, checkBoxes])
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="sm:flex sm:items-end mb-4">
            <div className="sm:flex-auto">
                <h1 className="text-2xl font-semibold text-gray-900">Listado de pagos</h1>
                                ...
                                <form className="mt-4">
                                    <div className="border-t border-gray-200 px-4 py-6">
                                        ...
                                        <div className="relative flex-1">
                                            <label htmlFor="search-pago" className="sr-only"> Buscar </label>
                               ...
                               {/* Fecha */}
                                ...
                                <div className="hidden sm:flex sm:items-baseline sm:space-x-8">
                                    ...
                                    <div className="relative z-10 inline-block text-left">
                                        <div>
                                            <button 
                                                onClick={() => setDropdownMetodo(!dropdownMetodo)}
                                        ...
                                        <form className="space-y-4" method="post" >
                                            <div className="flex items-center">
                                               ...
                                               className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500" />
                                                <label className="ml-3 pr-6 text-sm font-medium text-gray-900 whitespace-nowrap"> Tarjeta </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                <input 
                                                    type="checkbox"
                                                    name="EF"
                                                    checked={checkBoxes.EF}
                                                    onChange={handleCheckBoxChange}
                                                    className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500" />
                                                <label className="ml-3 pr-6 text-sm font-medium text-gray-900 whitespace-nowrap"> Efectivo </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                <input 
                                                     type="checkbox"
                                                     name="FO"
                                                     checked={checkBoxes.FO}
                                                     onChange={handleCheckBoxChange}
                                                    className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500" />
                                                <label className="ml-3 pr-6 text-sm font-medium text-gray-900 whitespace-nowrap"> Fonasa </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                <input 
                                                    type="checkbox"
                                                    name="IS"
                                                    checked={checkBoxes.IS}
                                                    onChange={handleCheckBoxChange}
                                                    className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500" />
                                                <label className="ml-3 pr-6 text-sm font-medium text-gray-900 whitespace-nowrap"> Isapre </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                <input 
                                                     ...
                                                     onChange={handleCheckBoxChange}
                                                     className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500" />
                                                <label className="ml-3 pr-6 text-sm font-medium text-gray-900 whitespace-nowrap"> Convenio </label>
                                            </div>
                                        </form>
                                        </div>
                                    )
                        ...
                        >
                              { pagos?.length !== 0 && pagos.map( item => (
                                    ...
                                    >
                                         ...
                                         <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">{item.cita}</td>
                                         ...
                                         <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">{item.folio}</td>
                                         <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">{item.cod_especialista}</td>
                                         <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">
                                            <span className={`py-0.5 px-1 rounded ${METODOS[item.metodo].color} text-white text-xs`}>{METODOS[item.metodo].nombre}</span>
                                         </td>

                                        <td className="relative whitespace-nowrap py-2 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 space-x-2">
                                            {/* <button
                                                //   x-on:click="modalCreate.cargarpago(25)"
                                                onClick={() => {
                                                    handleModalFormpago()
                                                    setPago({nombre: item.nombre, id:item.id})
                                                }}
