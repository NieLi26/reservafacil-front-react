...
const Categorias = () => {
    ...
    const handleSubmit = async e => {
        ...
        setCargando(true)
        // await submitcategoria({id, nombre})
        if ( categoria?.id ) {
            await editarCategoria({id, nombre});
        } else {
            await crearCategoria({id, nombre});
        }
    ...
    const handleModalFormCategoria = () => {
        handleModalForm()
        setCategoria({})
    }
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="sm:flex sm:items-end mb-4">
            ...
            <div className="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                <button 
                    onClick={handleModalFormCategoria}
        ...
        <ModalForm
            ...
            handleModalForm={handleModalFormCategoria}
            title={id ? 'Modificar Categoria' : 'Crear Categoria'}
        >
        ...
        <ModalEliminar
            handleEliminar={eliminarCategoria}
            id={categoria.id}
            title="Eliminar categoria"
            texto="Una categoria eliminada no se podra recuperar"
        >
        </ModalEliminar>
                                ...
                                <form className="mt-4">
                                    <div className="border-t border-gray-200 px-4 py-6">
                                        ...
                                        <div className="relative flex-1">
                                            <label htmlFor="search-categoria" className="sr-only"> Buscar </label>
                              ...
                              { categorias?.length !== 0 && categorias.map( item => (
                                    ...
                                    >
                                        ...
                                        <td className="relative whitespace-nowrap py-2 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 space-x-2">
                                            <button
                                                //   x-on:click="modalCreate.cargarcategoria(25)"
                                                onClick={() => {
                                                    handleModalFormCategoria()
                                                    setCategoria({nombre: item.nombre, id:item.id})
                                                }}
                                            ...
                                            <button
                                                ...
                                                onClick={() => {
                                                    setCategoria({id:item.id})
                                                    handleModalEliminar()
                                                }}
                                                // onClick={() => eliminarCategoria(t.id)}
