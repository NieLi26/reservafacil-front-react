...
const Horarios = () => {
    ...
    const handleSubmit = async e => {
        ...
        if ( [ especialista, dia, inicio, termino, duracion ].includes('') ) {
        ...
        if ( horario?.id ) {
            await editarHorario({
                id, especialista: especialista.id, dia, inicio, 
                termino, duracion
            });
        } else {
            await crearHorario({
    ...
    useEffect(() => {
        if ( horario?.id ) {
            setEspecialista(horario.especialista)
            setDia(horario.dia)
            setInicio(horario.inicio)
            setTermino(horario.termino)
  ...
  return (
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        <ModalForm
            ...
            handleModalForm={handleModalFormHorario}
            title={id ? 'Modificar horario' : 'Crear horario'}
        >
        ...
        <ModalEliminar
            ...
            texto="Una horario eliminada no se podra recuperar"
        >
        </ModalEliminar>
                                ...
                                <form className="mt-4">
                                    <div className="border-t border-gray-200 px-4 py-6">
                                        ...
                                        <div className="relative flex-1">
                                            <label htmlFor="search-horario" className="sr-only"> Buscar </label>
                        ...
                        >
                              { horarios?.length !== 0 && horarios.map( item => (
                                    ...
                                    >
                                        ...
                                        <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">{DIAS[item.dia]}</td>
                                         <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">{item.inicio} Hrs</td>
                                         <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">{item.termino} Hrs</td>
                                         <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">{item.duracion} Min</td>

                                        <td className="relative whitespace-nowrap py-2 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 space-x-2">
                                            <button
                                                //   x-on:click="modalCreate.cargarhorario(25)"
                                                onClick={() => {
                                                    handleModalFormHorario()
                                                    setHorario({
                                                        id: item.id,
                                            ...
                                            <button
                                                ...
                                                onClick={() => {
                                                    setHorario({id:item.id})
                                                    handleModalEliminar()
                                                }}
                                                // onClick={() => eliminarHorario(t.id)}
